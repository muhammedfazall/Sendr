      ...
      <div className="p-8 max-w-2xl">
        ...
        <div className="rounded-xl border p-5 mb-4" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
          ...
          <div>
            ...
            <div className="text-xs mt-1.5" style={{ color: 'var(--muted)' }}>Resets at UTC midnight</div>
          </div>
        </div>
...
function Skeleton() {
  return (
    <div className="max-w-2xl space-y-3 animate-pulse" role="status" aria-label="Loading dashboard">
